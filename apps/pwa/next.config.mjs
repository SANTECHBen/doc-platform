...
const nextConfig = {
  ...
  async headers() {
    ...
    const csp = [
      ...
      // - Mux: HLS playback iframe.
      // - view.officeapps.live.com: legacy raw-PPTX preview.
      // - YouTube/Vimeo: video_url content blocks on slide courses.
      "frame-src 'self' https://*.mux.com https://view.officeapps.live.com https://www.youtube.com https://www.youtube-nocookie.com https://player.vimeo.com",
      "font-src 'self' data:",
