...
function ToastItem({ toast, onDismiss }: { toast: Toast; onDismiss: () => void }) {
  ...
  return (
    <div
      role="status"
      className={`pointer-events-auto relative flex w-[min(360px,90vw)] items-start gap-3 overflow-hidden rounded-md border ${tone.border} bg-surface-raised p-3 pl-4 shadow-lg transition-all duration-200 ${
