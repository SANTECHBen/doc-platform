...
function SantechWordmark() {
  return (
    ...
    >
      ...
      <path d="m583.59,53.04h-51.29V15.59h149.57v37.45h-51.05v129.54h-47.23V53.04Z" />
      <path d="m829.53,146.08v36.5h-134.07V15.59h130.97v36.5h-84.21v28.15h74.19v35.31h-74.19v30.54h87.31Z" />
      <path d="m887.62,174.83c-13.92-7.4-24.85-17.69-32.8-30.89-7.96-13.2-11.93-28.15-11.93-44.85s3.97-31.65,11.93-44.85c7.95-13.2,18.88-23.5,32.8-30.89,13.92-7.4,29.62-11.09,47.12-11.09,15.27,0,29.02,2.71,41.27,8.11,12.25,5.41,22.42,13.2,30.54,23.38l-30.06,27.2c-10.82-13.04-23.94-19.56-39.36-19.56-9.06,0-17.14,1.99-24.21,5.96-7.08,3.98-12.57,9.58-16.46,16.82-3.9,7.24-5.84,15.55-5.84,24.93s1.95,17.69,5.84,24.93c3.89,7.24,9.38,12.84,16.46,16.82,7.07,3.98,15.15,5.96,24.21,5.96,15.42,0,28.54-6.52,39.36-19.56l30.06,27.2c-8.11,10.18-18.29,17.97-30.54,23.38-12.25,5.41-26,8.11-41.27,8.11-17.5,0-33.2-3.7-47.12-11.09Z" />
      <path d="m1182.36,15.59v166.99h-47.23v-65.13h-64.41v65.13h-47.23V15.59h47.23v62.74h64.41V15.59h47.23Z" />
    </svg>
  );
}
