...
import { Building2, Clapperboard, Puzzle, type LucideIcon } from 'lucide-react';
...
// sign-out flow, etc. The expectation is that admins spend most of their
// time inside an org (where OrgSidebar takes over), so this surface is
// minimal: pick an org, then go.
export function GlobalSidebar({ userMenu }: { userMenu?: ReactNode }) {
