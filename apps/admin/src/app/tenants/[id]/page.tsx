...
// Per-org privacy + access controls. Covers scan-gate opt-in and Microsoft
// tenant mapping. Tenant mapping is what scopes this org's admin users at
// sign-in — once set, anyone signing in with a Microsoft tid that matches
// lands in this org's data scope automatically.
function PrivacySection({
  ...
  return (
    <section className="mt-8 rounded-md border border-line bg-surface-raised p-5">
      <h2 className="mb-1 text-sm font-semibold text-ink-primary">Privacy & access</h2>
      ...
      <div className="mt-6 border-t border-line pt-5">
        ...
        <p className="mt-2 text-xs text-ink-tertiary">
          Don't forget to add the tenant to <code className="font-mono">AUTH_ALLOWED_TENANTS</code>{' '}
          on the API for the customer's sign-ins to be accepted.
        </p>
      </div>
    </section>
  );
